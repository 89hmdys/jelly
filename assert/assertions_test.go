...
//	Equal(123, 123)
//	Equal(123.5, 123.5)
//	Equal([]byte("Hello World"), []byte("Hello World"))
//	Equal(nil, nil)
//	Equal(int32(123), int32(123))
//	Equal(uint64(123), uint64(123))
//
//}
//
...
//	}()
//
//	NotNil(new(AssertionTesterConformingObject))
//	NotNil(nil)
//	NotNil((*struct{})(nil))
//}
//
...
//	}()
//
//	NotEqual("Hello World", "Hello World!")
//	NotEqual(123, 1234)
//	NotEqual(123.5, 123.55)
//	NotEqual([]byte("Hello World"), []byte("Hello World!"))
//	NotEqual(nil, new(AssertionTesterConformingObject))
//
//	funcA := func() int { return 23 }
//	funcB := func() int { return 42 }
//
//	NotEqual(funcA, funcB)
//	NotEqual("Hello World", "Hello World")
//	NotEqual(123, 123)
//	NotEqual(123.5, 123.5)
//	NotEqual([]byte("Hello World"), []byte("Hello World"))
//	NotEqual(new(AssertionTesterConformingObject), new(AssertionTesterConformingObject))
//}
//
////
////type A struct {
...
//	True(isEmpty([]string{}))
//	True(isEmpty(0))
//	True(isEmpty(int32(0)))
//	True(isEmpty(int64(0)))
//	True(isEmpty(false))
//	True(isEmpty(map[string]string{}))
//	True(isEmpty(new(time.Time)))
//	True(isEmpty(time.Time{}))
//	True(isEmpty(make(chan struct{})))
//	False(isEmpty("something"))
//	False(isEmpty(errors.New("something")))
//	False(isEmpty([]string{"something"}))
//	False(isEmpty(1))
//	False(isEmpty(true))
//	False(isEmpty(map[string]string{"Hello": "World"}))
//	False(isEmpty(chWithValue))
//
//}
//
...
var emptyStr = ""
var emptyArr = make([]string, 0)
var zero = 0
var falseBool = false
var emptyMap = make(map[string]string)
var notEmptyStr = "something"
var err = errors.New("something")
var notEmptyArr = []string{"something"}
var one = 1
var trueBool = true
var notEmptyMap = map[string]string{"Hello": "World"}
...
func TestAssert(t *testing.T) {
	...
	func() {
		...
		Empty(falseBool)
		Empty(notEmptyMap)
		NotEmpty(notEmptyStr)
		NotEmpty(err)
		NotEmpty(notEmptyMap)
		NotEmpty(one)
		NotEmpty(trueBool)
		NotEmpty(notEmptyArr)
	}()
...
func TestIf(t *testing.T) {
	...
	if notEmptyArr == nil || len(notEmptyArr) == 0 {
		t.Fail()
